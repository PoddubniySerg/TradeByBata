package com.test.feature_profile.presentation.ui.fragments
...
import com.test.feature_profile.presentation.viewmodels.ProfileViewModel
...
class ProfileFragment :
    ...
    private val viewModel by viewModels<ProfileViewModel> {
        (requireContext().applicationContext as ProfileComponentProvider)
            .profileComponent()
    ...
    private fun handleLogOut(isLogOut: Boolean) {
        if (isLogOut) {
            val navOptions = NavOptions.Builder()
                .setPopUpTo(R.id.signInFragment, inclusive = true, saveState = false)
                .build()
            navigateToParent(
                R.id.signInFragment,
                data = null,
