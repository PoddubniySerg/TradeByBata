...
class AccountsRepository(
...
) : LoginAccountsRepository, SignInAccountsRepository, ProfileAccountsRepository {
    ...
    override suspend fun savePhoto(uri: String, content: ByteArray) {
        fileStorage.save(uri, content)
    }

    override suspend fun remove(id: Int) {
        fileStorage.remove(accountsDao.getPhotoUri(id))
        accountsDao.remove(id)
    }
